...
{
	/// <summary>Factory used to create the AIACertificateSource</summary>
	/// <version>$Revision: 1887 $ - $Date: 2013-04-23 14:56:09 +0200 (mar., 23 avr. 2013) $
	/// 	</version>
	public class AIACertificateFactoryImpl : CertificateSourceFactory
	{
		private HTTPDataLoader httpDataLoader;

		/// <param name="httpDataLoader">the httpDataLoader to set</param>
		public virtual void SetHttpDataLoader(HTTPDataLoader httpDataLoader)
		{
			this.httpDataLoader = httpDataLoader;
		}

		public virtual CertificateSource CreateAIACertificateSource(X509Certificate certificate
			)
		{
