...
{
    /// <summary>The validation of a certificate may require to access some CRL.</summary>
    /// <remarks>
    ...
    {
        /// <summary>Finds the request CRL.</summary>
        /// <remarks>Finds the request CRL.</remarks>
