...
{
	/// <summary>Validation information for level EPES.</summary>
	/// <remarks>Validation information for level EPES.</remarks>
	...
	public class SignatureLevelEPES : SignatureLevel
	{
		...
		/// <returns></returns>
		/// <seealso cref="EU.Europa.EC.Markt.Dss.Validation.AdvancedSignature.GetPolicyId()"
		/// 	>EU.Europa.EC.Markt.Dss.Validation.AdvancedSignature.GetPolicyId()</seealso>
