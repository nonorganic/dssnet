...
{
	/// <summary>Validation information for level T (CAdES, PAdES, XAdES) of a signature.
	/// 	</summary>
	/// <remarks>Validation information for level T (CAdES, PAdES, XAdES) of a signature.
	/// 	</remarks>
	/// <version>$Revision: 1887 $ - $Date: 2013-04-23 14:56:09 +0200 (mar., 23 avr. 2013) $
	/// 	</version>
	public class SignatureLevelT : SignatureLevel
	{
		private IList<TimestampVerificationResult> signatureTimestampsVerification;
		...
		/// <returns>the signatureTimestampVerification</returns>
		public virtual IList<TimestampVerificationResult> GetSignatureTimestampVerification
			()
		{
