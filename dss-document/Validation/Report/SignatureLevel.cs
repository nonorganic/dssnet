...
{
	/// <summary>Base class for SignatureLevel related classes.</summary>
	/// <remarks>Base class for SignatureLevel related classes.</remarks>
	...
	public abstract class SignatureLevel
	{
		...
		/// <returns>the levelReached</returns>
		public virtual Result GetLevelReached()
		{
			return levelReached;
		}
	}
