...
{
	/// <summary>Contains information about the validity of a signature.</summary>
	/// <remarks>Contains information about the validity of a signature.</remarks>
	/// <version>$Revision: 1887 $ - $Date: 2013-04-23 14:56:09 +0200 (mar., 23 avr. 2013) $
	/// 	</version>
	public class SignatureVerification
	{
        /// <summary>specifies if the signature is mathematically correct or not</summary>
        /// <returns>the signature verification result</returns>
		public Result SignatureVerificationResult { get; private set; }
        
        /// <summary>Provides the name of the algorithm applied for the signature</summary>
