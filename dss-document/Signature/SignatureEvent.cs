...
{
	/// <summary>Represents an event in the process of creating/validating a e-signature</summary>
    ...
    public class SignatureEvent
    {
        ...
        /// <returns></returns>
        public SignatureEventType Type { get; set; }

        /// <summary>The default constructor for SignatureEvent.</summary>
        /// <remarks>The default constructor for SignatureEvent.</remarks>
